...
export const cvProfiles: CvProfile[] = [
  {
    ...
    summaryPoints: [
      ...
      'Menangani seluruh siklus: analisis kebutuhan, logika bisnis, debugging, dokumentasi, deployment, dan pemeliharaan.',
  ...
  },
  {
    ...
    headline: 'Network Engineer & MikroTik Administrator',
    summary:
      'Pengelola jaringan sekolah yang merancang topologi tujuh kelas dan membangun sendiri aplikasi pemantau routernya.',
    summaryPoints: [
      'Topologi bertingkat: ISP > MikroTik > switch manageable > router mode AP, seluruh jalur utama gigabit.',
      'Tujuh ruang kelas dilayani lewat kabel Cat 6 yang ditarik, diterminasi, dan diuji sendiri.',
      'Konfigurasi RouterOS: DHCP, IP statis, hotspot, grup bandwidth, dan aturan firewall.',
      'Penyaringan konten berlapis: address-list, aturan TLS/SNI, serta penguncian DNS terhadap DoT dan DoH.',
      'Aplikasi pemantau sendiri di mikrotik.smaafbs.sch.id, memakai klien RouterOS API di atas socket PHP.',
      'Berlatar pengembang, sehingga otomatisasi dan integrasi jaringan dapat dibangun sendiri, bukan hanya dikonfigurasi.',
    ],
    fileName: 'cv-putra-kamulyan-network-engineer.pdf',
    skillGroups: ['network', 'tools', 'backend', 'database', 'network-roadmap'],
    featuredProjects: ['jaringan-smaafbs'],
    showCertifications: false,
    showAdditionalSkills: true,
  },
  {
    ...
    skillGroups: ['tools', 'network', 'database', 'backend', 'additional'],
    featuredProjects: ['sma-afbs', 'jaringan-smaafbs'],
    showCertifications: false,
    showAdditionalSkills: true,
  },
  {
